...
describe("Early Birds Traits Contract Testing", function () {
    ...
    describe('Deployment', function () {
        it('Sets the contracts and the accounts', async () => {
            ...
            birdBathContract = await birdBath.deploy("https://bafkreibmddszibrpxbik4pbqggahpncmk5krcjkyc73wkp3756vr2pnpky.ipfs.nftstorage.");
    ...
    describe('Gets traits of tokens', async () => {
        ...
        it('Gets traits of token', async () => {
            await wETHContract.approve(gameContract.address, ethers.utils.parseEther('.15'))
            await gameContract.mint(3,true,BigInt(11912372696322013812339097185306443775573840930383684865192230861215769821184))  
